 ...
 */
export default function BracketHeading({ as: Tag = "h2", children, className = "", dark = false }) {
  return (
    <Tag className={`bracket-heading bracket-link ${dark ? "bracket-link-dark" : ""} ${className}`}>
